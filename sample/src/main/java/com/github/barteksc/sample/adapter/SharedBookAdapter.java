...
public class SharedBookAdapter extends BaseAdapter {
    ...
    public SharedBookAdapter(Context mContext, List<SharedBookModel> mSharedBookModelList) {
...
//        getUserInfoByUsername(sharedBook.getNewsUsername());
    ...
    private void setEventHandler(SharedBookModel sharedBook) {
        ...
        llItem.setOnLongClickListener(view -> {
//            final String[] option = {"hello", "xin chao"};
//            ArrayAdapter<String> adapter = new ArrayAdapter<String>(mContext, android.R.layout.select_dialog_item, option);
...
//            final AlertDialog alertDialog = builder.create();
            ...
            builder.setPositiveButton("Sửa bản tin", (dialogInterface, i) -> {
...
//                intent.putExtra("password", password);
            ...
            builder.setNegativeButton("Xóa bản tin", (dialogInterface, i) -> {
