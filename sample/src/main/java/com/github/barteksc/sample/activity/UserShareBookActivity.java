...
public class UserShareBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_shared_book);
        findViewByIds();
        getDataFromBundle();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_shared_book_create_new:
                Intent intent = new Intent(UserShareBookActivity.this, AddSharedBookActivity.class);
    ...
    private void findViewByIds() {
        toolbar = findViewById(R.id.toolbar_user_shared_book);
        gvAllSharedBooks = findViewById(R.id.gv_user_shared_book);
    }
}
