...
public class BookDetail extends AppCompatActivity {
    ...
    @ViewById(R.id.bookDetailImage)
    ImageView bookImage;
    @ViewById(R.id.bookDetailTitle)
    TextView bookTitle;
    @ViewById(R.id.ratingbar)
    RatingBar ratingBar;
    @ViewById(R.id.bookDetailCategory)
    TextView bookCategory;
    @ViewById(R.id.bookDetailAuthor)
    TextView bookAuthor;
    @ViewById(R.id.bookDetailPublicDate)
    TextView bookPublicDate;
    @ViewById(R.id.bookDetailPages)
    TextView bookPages;
    @ViewById(R.id.bookDetailRating)
    TextView bookRating;
    @ViewById(R.id.bookDetailRatedTime)
    ...
    @Click(R.id.btn_ReadBook)
    void transferToBookViewer() {
        addReadingHistory();
    }

    @Click(R.id.btn_bookDetailDescription)
...
//    }
    ...
    void addReadingHistory() {
        apiService.addReadingHistory(CreateJsonObject.readingHistory(book.getBookId(), usernameLogin)).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                Intent intent = new Intent(BookDetail.this, PDFViewActivity_.class);
